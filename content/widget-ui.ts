...
const en: WidgetUi = {
  ...
  demoOnly: "Demo only. Nothing is sent anywhere.",
  ...
  wantThis: "Want this on your site?",
...
const pt: WidgetUi = {
  ...
  demoOnly: "Apenas demonstração. Nada é enviado para lado nenhum.",
  ...
  wantThis: "Quer isto no seu site?",
